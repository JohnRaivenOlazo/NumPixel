...
const Lagrange = () => {
  ...
  const calculateInterpolation = () => {
    ...
    // Calculate interpolated value using Lagrange interpolation formula
    ...
    for (let i = 0; i < xArray.length; i++) {
        ...
        // Construct numerator and denominator fractions
  ...
  return (
    <div className="calculator max-w-md mx-auto p-4 bg-white shadow-md rounded-md overflow-x-auto">
      <h2 className="text- text-2xl font-bold mb-4 text-purple-800 uppercase">Lagrange Interpolation</h2>
      {/* Input fields */}
      {/* X Values */}
